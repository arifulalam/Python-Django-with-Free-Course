...
def about(request):
    ...
    title = _about.filter(Section = 'About', Key = 'Title').values()[0]['Value']
    subtitle = _about.filter(Section = 'About', Key = 'subtitle').values()[0]['Value']
    about = {
        'Birthday': _about.filter(Section = 'About', Key = 'Birthday').values()[0]['Value'],
        'Age': _about.filter(Section = 'About', Key = 'Age').values()[0]['Value'],
        'Website': _about.filter(Section = 'About', Key = 'Website').values()[0]['Value'],
        'Degree': _about.filter(Section = 'About', Key = 'Degree').values()[0]['Value'],
        'Phone': _about.filter(Section = 'About', Key = 'Phone').values()[0]['Value'],
        'Email': _about.filter(Section = 'About', Key = 'Email').values()[0]['Value'],
        'City': _about.filter(Section = 'About', Key = 'City').values()[0]['Value'],
        'Hometown': _about.filter(Section = 'About', Key = 'Hometown').values()[0]['Value'],
        'Description': _about.filter(Section = 'About', Key = 'Description').values()[0]['Value'],
    }
    skills = About.objects.filter(Section = 'Skills')
    interests = About.objects.filter(Section = 'Interests')
    testimonials = Testimonial.objects.all()

    print(_about, title, subtitle, about, skills, interests, testimonials)
